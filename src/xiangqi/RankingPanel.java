...
public class RankingPanel extends javax.swing.JPanel {
    ...
    public RankingPanel(CardLayout cardlayout, JPanel cardpanel) {
    ...
    public void update(){
        ...
        User[] found = new User[50];
            ...
            for (int i = 0; i < found.length; i++) {
                if (found[i] != null) {
                    RankPanel paneluser = new RankPanel(found[i]);
                    ranking.add(paneluser);
                    ranking.revalidate();
                    ranking.repaint();
                }
    ...
    private void initComponents() {
        ...
        ranking.setLayout(new javax.swing.BoxLayout(ranking, javax.swing.BoxLayout.PAGE_AXIS));
